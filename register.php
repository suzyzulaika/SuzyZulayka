                                    ...
                                    <div class="card-body">
                                        <?php
                                            if(isset($_POST['register'])) {
                                                ...
                                                $insert = mysqli_query($koneksi, "INSERT INTO user(namalengkap,email,alamat,no_telp,username,password,level) VALUE('$namalengkap','$email','$alamat','$no_telp','$username','$password','$level')");

                                                if($insert){
                                                    echo '<script>alert("Selamat, register berhasil Silahkan Login"); location.href="login.php"</script>';
                                                }else{
                                                    echo '<script>alert("Register gagal, Silahkan ualngin kembali.");</script>';
                                                }
                                            }    
                                        ?>
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" type="text" required name="namalengkap" placeholder="Masukan Nama Lengkap" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" type="text" required name="no_telp" placeholder="Masukan No. Telpon" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="level" required class="from-control">
